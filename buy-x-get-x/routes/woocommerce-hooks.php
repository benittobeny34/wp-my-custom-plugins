...
$actions = [
    ...
    'woocommerce_before_calculate_totals' => ['type' => 'action', 'callable' => [CartController::class, 'updatePricesIfCartItemHasBuyXGetXEnabled'], 'priority' => 10, 'accepted_args' => 1],
...
$filters = [
    'woocommerce_add_to_cart' => ['type' => 'filter', 'callable' => [CartController::class, 'duplicateProductAndAddToCart'], 'priority' => 10, 'accepted_args' => 6],
