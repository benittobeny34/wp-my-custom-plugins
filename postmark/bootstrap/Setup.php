...
class Setup
{
    ...
    {
        register_activation_hook(SP_PREFIX_PLUGIN_FILE, [__CLASS__, 'activate']);
        register_deactivation_hook(SP_PREFIX_PLUGIN_FILE, [__CLASS__, 'deactivate']);
        register_uninstall_hook(SP_PREFIX_PLUGIN_FILE, [__CLASS__, 'uninstall']);
